...
public abstract class CommonApp extends LoggingMain {
    ...
    public void init(Component centerForComponent, boolean exitOnClose,String sPath) 
    {
    	 init(null, true);    	 
         solverAndPersistenceFrame.LoadSolution(sPath); //szsz zaladuj konfiguracje 
         solverAndPersistenceFrame.PerformClickSolveButton(); //szsz uruchom symulacje
    }
