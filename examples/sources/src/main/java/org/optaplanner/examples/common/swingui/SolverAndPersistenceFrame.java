...
public class SolverAndPersistenceFrame extends JFrame {
    ...
    public void LoadSolution(String sPathFileName)
    {
    	OpenAction temp = (OpenAction) openAction;
    	
    	temp.loadSolution(sPathFileName);
    	
    	PathFileName = sPathFileName;
    }
    
    public void PerformClickSolveButton()
    {
    	solveAction.actionPerformed(null);
    }
    
//    public void CloseImmidiatlyAfterSolve(Boolean action)
//    {
//    	SolveAction action  .CloseImmediately = action
//    }
    ...
    private class SolveAction extends AbstractAction {
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            new SolveWorker(planningProblem,PathFileName).execute();
        }
    ...
    protected class SolveWorker extends SwingWorker<Solution, Void> {
        ...
        public SolveWorker(Solution planningProblem,String sPathFileName) 
        {
        ...
        private void saveToFileBestScore(String sPath,String score) throws IOException
        {
        	score = score.replaceAll("0hard/", "");
        	score = score.replaceAll("soft", "");
        	...
        	if(!fileResult.exists())
        	 ...
        	 FileWriter fw = new FileWriter(resultFile,true); //the true will append the new data
        	 fw.write(sPath + ";" + score + ";\n");//appends the string to the file
        	 fw.close();
    ...
    private class OpenAction extends AbstractAction {
        ...
        public void actionPerformed(ActionEvent e) {       	        	
            ...
            if (approved == JFileChooser.APPROVE_OPTION) {
                setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
                try {
                    solutionBusiness.openSolution(fileChooser.getSelectedFile()); //szsz //otwieranie pliku
                    setSolutionLoaded();
                } finally {
                    setCursor(Cursor.getDefaultCursor());
                }
        ...
        public void loadSolution(String sPathFileName)
        {
        	 try 
        	 {
        		 File tempFile = new File(sPathFileName);
        		 solutionBusiness.openSolution(tempFile); //szsz //otwieranie pliku
                 setSolutionLoaded();
             } finally {
                 setCursor(Cursor.getDefaultCursor());
             }
