...
set "jvmOptions=-Xms256m -Xmx1024m -Dorg.optaplanner.examples.dataDir=sources/data/"
set "mainClass=org.optaplanner.examples.vehiclerouting.app.VehicleRoutingApp"
set "mainClasspath="
...
if exist "%JAVA_HOME%\bin\java.exe" (
    ...
    "%JAVA_HOME%\bin\java" !jvmOptions! -server -cp !mainClasspath! !mainClass! %1
    goto endProcess
) else (
    ...
    "!jreHome!\bin\java" !jvmOptions! -cp !mainClasspath! !mainClass! %1
    goto endProcess
)
